...
const ErrorCause    ERROR_CAUSE_OPEN_DEV_IN     = 0x00;
const ErrorCause    ERROR_CAUSE_OPEN_DEV_OUT    = 0x01;

const ErrorWhen     ERROR_WHEN_SEND_MESSAGE     = 0x40;
const ErrorWhen     ERROR_CAUSE_MSB             = 0x11;
const ErrorWhen     ERROR_CAUSE_LSB             = 0x12;
